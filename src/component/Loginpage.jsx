...
const Loginpage = () => {
  ...
  const check = ()=>{
    ...
    const logindetails = axios.post("http://localhost:3000/login",{"email":email,"password":pass})
  ...
  return (
    <div className=' relative w-full h-screen bg-black'>
      ...
      <div className='flex absolute top-16 right-6 sm:top-28 left-10 sm:left-16 md:left-42 lg:left- justify-center items-center '>
